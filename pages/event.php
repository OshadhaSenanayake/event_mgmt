...
<div>
    ...
    <div id="edit_general" style="height:250px;" class="newevent">
        <?php
            echo '<a style="float:right" href="../pages/profile.php?eventid='.$eventid.'">[close]</a>';
        ?>
    ...
    <div id ="budget" style = "height:400px" class = "newevent">
        ...
        <div style="overflow:auto;height:250px;font-size:12px;">
            ...
            <button onclick = "set_type('checkout')">Checkout</button>
        </div>
        
    <div id ="checkout" style = "height:200px" class = "newevent">
        Checkout
        <?php
                    echo '<a style="float:right" href="../pages/profile.php?eventid='.$eventid.'&budget=on">[close]</a>';

        ?>
        <br>
        <span style="font-size:12px;top:200px;">Deposit the due amount to the following bank account and attach a copy of the receipt here.
        <br>Account No: 012-1023-2015
        <br>People's Bank Thimbirigasyaya Branch
        <br>
        <form  action ="../server/server.php" method="POST">
        <input type="file" name="fileToUpload" id="fileToUpload">
         <?php echo '<input type="hidden" name="eventid" value = "'.$eventid.'">';?>
        <button style="height:30px" type="submit" name="submit_receipt">Upload</button>
        </form>
        <br>
        Or send in as an email to <a href ="mailto:finance@party.lk"> finance@party.lk</a>
        </span>
        </div>
